...
class TestServerRoutes:
    ...
    def test_stop_server_no_process(
        self, mock_no_process, mock_psutil, authenticated_client, app, test_server
    ):
    ...
    def test_delete_server_success(
        self, mock_exists, mock_rmtree, authenticated_client, app, test_server
    ):
