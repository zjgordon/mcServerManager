...
class TestSecurityVulnerabilities:
    ...
    def test_xss_in_server_name_display(self, authenticated_client, app):
        ...
        for xss_payload in xss_attempts:
            ...
            assert not is_valid_server_name(xss_payload), f"XSS payload '{xss_payload}' should be rejected"
    ...
    def test_command_injection_server_operations(self, authenticated_client, app, test_server):
        ...
        for name in malicious_names:
            ...
            assert not is_valid_server_name(name), f"Command injection payload '{name}' should be rejected"
    ...
    def test_directory_traversal_in_paths(self, authenticated_client, app):
        ...
        with patch('os.makedirs') as mock_makedirs, \
             patch('app.routes.server_routes.find_next_available_port') as mock_port, \
            ...
            if mock_makedirs.called:
                ...
                assert called_path.startswith('servers/'), f"Path '{called_path}' should be contained in servers directory"
        ...
        try:
            ...
            with patch('subprocess.Popen') as mock_popen:
                ...
                if mock_popen.called:
                    ...
                    assert isinstance(args, list), "Command should be passed as list to prevent shell injection"
