...
class ProductionConfig(BaseConfig):
    ...
    DEFAULT_SERVER_MEMORY_MB = int(os.environ.get('DEFAULT_SERVER_MEMORY_MB', '2048'))  # 2GB default
    ...
    MAX_CONTENT_LENGTH = int(os.environ.get('MAX_CONTENT_LENGTH', str(32 * 1024 * 1024)))  # 32MB default
    ...
    def validate_production_config(cls) -> dict:
        ...
        if cls.SQLALCHEMY_DATABASE_URI and not cls.SQLALCHEMY_DATABASE_URI.startswith(('sqlite:///', 'postgresql://', 'mysql://')):
